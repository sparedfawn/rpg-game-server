...
@Getter
@Setter
public class Cape extends SuitableItem {
  ...
  public Map<Statistics, Integer> incrementStatistic() {
    ...
    return Map.of(Statistics.DEXTERITY, 3 * super.getLevel(),
        Statistics.INTELLIGENCE, 3 * super.getLevel());
  }

  @Override
  public EffectSource sourceType() {

    return EffectSource.CAPE;
  }
}
